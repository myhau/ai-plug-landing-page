...
export default function Features02() {
  ...
  const heading1 = "Coming soon";
  const paragraph1 = "Whenever you are ready, just hit publish to turn your site sketches into an actual designs. No creating, no skills, no reshaping.";

  const heading2 = "Attach files and directories as context";
  const paragraph2 = "Create teams and organize your designs into folders using project specs and insights.";

  const heading3 = "Easily accessible history";
  const paragraph3 = "Generate images and explore new ways of presenting your designs with AI.";

  const heading4 = "Fire and forget";
  const paragraph4 = "Send queries and be notified when they finish";

  const heading5 = "Plugins";
  const paragraph5 = "";

  const heading6 = "Browser and IDE integration";
  const paragraph6 = "Ask questions about the currently open tab or file in editor";
      ...
      <div className="py-12 md:py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="relative max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="font-inter-tight text-3xl md:text-4xl font-bold text-zinc-900 mb-4">{heading1}</h2>
            <p className="text-lg text-zinc-500">{paragraph1}</p>
          </div>
            ...
            <article className="sm:col-span-2 flex flex-col border border-transparent [background:linear-gradient(theme(colors.white),theme(colors.zinc.50))_padding-box,linear-gradient(120deg,theme(colors.zinc.300),theme(colors.zinc.100),theme(colors.zinc.300))_border-box] rounded-lg">
              <div className="grow flex flex-col p-5 pt-6">
                <div className="flex items-center space-x-3 mb-1">
                  ...
                  <h3 className="font-inter-tight font-semibold text-zinc-900">{heading2}</h3>
                </div>
                <p className="grow max-w-md text-sm text-zinc-500">{paragraph2}</p>
              </div>
              <figure>
            ...
            <article className="flex flex-col border border-transparent [background:linear-gradient(theme(colors.white),theme(colors.zinc.50))_padding-box,linear-gradient(120deg,theme(colors.zinc.300),theme(colors.zinc.100),theme(colors.zinc.300))_border-box] rounded-lg">
              <div className="grow flex flex-col p-5 pt-6">
                <div className="flex items-center space-x-3 mb-1">
                  ...
                  <h3 className="font-inter-tight font-semibold text-zinc-900">{heading3}</h3>
                </div>
                <p className="grow max-w-md text-sm text-zinc-500">{paragraph3}</p>
              </div>
              <figure>
            ...
            <article className="flex flex-col border border-transparent [background:linear-gradient(theme(colors.white),theme(colors.zinc.50))_padding-box,linear-gradient(120deg,theme(colors.zinc.300),theme(colors.zinc.100),theme(colors.zinc.300))_border-box] rounded-lg">
              <div className="grow flex flex-col p-5 pt-6">
                <div className="flex items-center space-x-3 mb-1">
                  ...
                  <h3 className="font-inter-tight font-semibold text-zinc-900">{heading4}</h3>
                </div>
                <p className="grow max-w-md text-sm text-zinc-500">{paragraph4}</p>
              </div>
              <figure>
            ...
            <article className="flex flex-col border border-transparent [background:linear-gradient(theme(colors.white),theme(colors.zinc.50))_padding-box,linear-gradient(120deg,theme(colors.zinc.300),theme(colors.zinc.100),theme(colors.zinc.300))_border-box] rounded-lg">
              <div className="grow flex flex-col p-5 pt-6">
                <div className="flex items-center space-x-3 mb-1">
                  ...
                  <h3 className="font-inter-tight font-semibold text-zinc-900">{heading5}</h3>
                </div>
                <p className="grow max-w-md text-sm text-zinc-500">{paragraph5}</p>
              </div>
              <figure>
            ...
            <article className="flex flex-col border border-transparent [background:linear-gradient(theme(colors.white),theme(colors.zinc.50))_padding-box,linear-gradient(120deg,theme(colors.zinc.300),theme(colors.zinc.100),theme(colors.zinc.300))_border-box] rounded-lg">
              <div className="grow flex flex-col p-5 pt-6">
                <div className="flex items-center space-x-3 mb-1">
                  ...
                  <h3 className="font-inter-tight font-semibold text-zinc-900">{heading6}</h3>
                </div>
                <p className="grow max-w-md text-sm text-zinc-500">{paragraph6}</p>
              </div>
              <figure>
