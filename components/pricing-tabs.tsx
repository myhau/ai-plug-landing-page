        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="pb-12 md:pb-20">
            ...
            <div className="max-w-sm mx-auto grid gap-6 lg:grid-cols-3 items-start lg:max-w-none">
              ...
              <div className="h-full">
                <div
                  className="relative flex flex-col h-full p-6 rounded-lg border border-transparent [background:linear-gradient(theme(colors.zinc.50),theme(colors.zinc.50))_padding-box,linear-gradient(120deg,theme(colors.zinc.300),theme(colors.zinc.100),theme(colors.zinc.300))_border-box]">

                  <div className="mb-4">
                    <div className="text-lg text-zinc-900 font-semibold mb-1">Premium Annual - early adopter
                    </div>
                    <div className="font-inter-tight inline-flex items-baseline mb-2">
                      <span className="text-zinc-900 font-bold text-2xl">$</span>
                      <span
                    ...
                    <ul className="text-zinc-600 dark:text-zinc-400 text-sm space-y-3 grow">
                      ...
                      <li className="flex items-center">
                        ...
                        <Tooltip id="18" content="Lorem Ipsum is simply dummy text of the printing.">
                          Two-time-use discount code for 15% (valid forever, one code valid for 12 months of subscription).
                        </Tooltip>
                      </li>
                      <li className="flex items-center">
                        <svg className="w-3 h-3 fill-emerald-500 mr-3 shrink-0" viewBox="0 0 12 12"
                      ...
                      <li className="flex items-center">
                        ...
                        <Tooltip id="16" content="Lorem Ipsum is simply dummy text of the printing.">
                          Support in less than 1 hour (CET zone).
                        </Tooltip>
                      </li>
                      <li className="flex items-center">
                        <svg className="w-3 h-3 fill-emerald-500 mr-3 shrink-0" viewBox="0 0 12 12"
